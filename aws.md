...
* Types of EC2 storage
    ...
    * EFS (Elastic File System)  - network storage (NFS, therefore no Windows support), can be mounted on multiple ec2 instances and this storage can be available in multiple AZ. File tree level.
